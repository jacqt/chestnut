...
(defn files-to-render [opts]
  (cond-> ["project.clj"
           ...
           "src/cljs/chestnut/index.cljs"
           "src/cljs/chestnut/models.cljs"
           "src/cljs/chestnut/router.cljs"
           "src/cljs/chestnut/components/dashboard.cljs"
           "src/cljs/chestnut/components/event.cljs"
           "src/cljs/chestnut/components/landing_page.cljs"
           "src/cljs/chestnut/components/login_signup.cljs"
           "src/cljs/chestnut/utils/auth.cljs"
           "src/cljs/chestnut/utils/http.cljs"
           "src/cljs/chestnut/utils/inputs.cljs"
